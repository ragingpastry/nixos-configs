{ inputs, config, lib, pkgs, ... }: {
  ...
  # This has been removed. I wonder what else we might have to do...
  ...
  networking.extraHosts =
    ''
      ...
      10.92.1.169 ui01.dart.blacklabel.mil
      10.92.1.165 auth01.dart.blacklabel.mil
      10.92.1.173 vault01.dart.blacklabel.mil
      10.92.1.167 results01.dart.blacklabel.mil
      10.92.1.166 resmgr01.dart.blacklabel.mil
    '';
